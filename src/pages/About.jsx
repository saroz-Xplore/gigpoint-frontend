    ...
    <div className="bg-white font-sans">
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12">
          ...
          <div className="md:w-1/2">
            <h1 className="text-3xl font-extrabold text-blue-600 tracking-wide font-serif mb-2">About GigPoint</h1>
            <p className="text-lg leading-relaxed text-gray-700">
              GigPoint is a platform built to solve real problems people face at home — whether it’s a leaking pipe,
              electrical issue, cleaning needs, or general repairs.
              <br />
              <br />
              We make it easy for anyone to post a job when they need help with something at home. Once a job is posted,
              skilled workers who match the job can apply. The person who posted the job gets to choose the right worker
              based on their skills and experience.
              <br />
              <br />
              Our goal is to connect people who need help with trusted local workers in a simple and fast way. No more
              calling around or waiting for someone to show up. Just post your job and get it done.
              <br />
              <br />
              At GigPoint, we believe in giving equal opportunities to workers and making life easier for everyone at home.
            </p>
          </div>
      ...
      <div className="bg-blue-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">Our Technology Stack</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 text-center">
            <TechItem Icon={FaReact} label="React.js" color="text-blue-500" />
            <TechItem Icon={SiTailwindcss} label="Tailwind CSS" color="text-cyan-400" />
            ...
            <TechItem Icon={FaJsSquare} label="JavaScript" color="text-yellow-400" />
            <TechItem Icon={FaCode} label="TypeScript" color="text-blue-700" />
            <TechItem Icon={FaEnvelope} label="Nodemailer" color="text-red-500" />
            <TechItem Icon={FaDatabase} label="Redis" color="text-red-600" />
            <TechItem Icon={FaUserShield} label="Passport.js" color="text-blue-800" />
            <TechItem Icon={FaCloud} label="Cloudinary" color="text-blue-400" />
            <TechItem Icon={FaFileUpload} label="Multer" color="text-indigo-600" />
            <TechItem Icon={FaRobot} label="Google AI" color="text-green-600" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-blue-800 mb-4">Meet Our Developers</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Behind GigPoint are passionate developers who crafted both frontend and backend with dedication.
          </p>
        </div>
