...
const WorkerDashboard = () => {
  ...
  useEffect(() => {
    ...
    // Fetch suggested works dynamically
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      {/* Sidebar */}
      <aside
        className="bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300
                   flex flex-col
                   w-full md:w-64
                   h-auto md:h-screen
                   p-4 md:p-6
                   border-b md:border-b-0 md:border-r border-blue-200"
      >
        ...
        <div className="p-3 bg-white rounded-xl shadow text-left">
          <h1
            className="text-sm md:text-md font-semibold text-blue-900 mb-2 border-b-2 border-blue-500 pb-1 whitespace-nowrap overflow-hidden text-ellipsis"
          ...
          <div className="text-xs md:text-sm text-blue-800 space-y-3">
            <div className="flex items-center">
              ...
              <svg
                ...
                className="w-5 h-5 mr-2 flex-shrink-0 text-blue-600"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
